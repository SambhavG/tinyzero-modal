...
def train(*arglist) -> None:
    ...
    # Ensure Weights & Biases logs under the correct workspace
    os.environ.setdefault("WANDB_ENTITY", "sambhavg")
    os.environ.setdefault("WANDB_PROJECT", "verl_grpo_example_qwen2-0.5b")
    os.environ.setdefault("WANDB_NAME", "qwen2-0.5b_example")
